...
<div class="container">
  ...
  <h5>電話番号</h5>
    ...
    <div class="col-sm-10 form-inline" style="padding: 3px;">
      <input type="text" class="form-control input-sm" id="name" placeholder="電話番号" size="45" value="09000000000">
    </div>
  </div>
  <div class="row">
  <h5>パスワード</h5>
    ...
    <div class="col-sm-10 form-inline" style="padding: 3px;">
      <input type="password" class="form-control input-sm" placeholder="パスワード" size="45" value="1129110403">
    </div>
  </div>
   </div>
   <div class="text-center">
