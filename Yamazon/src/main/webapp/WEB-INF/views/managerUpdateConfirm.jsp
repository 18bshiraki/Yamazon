...
<form:form action="managerUpdateResult" method="post" modelAttribute="yamazon">
	<div class="text-center">
			...
			<div class="row">
				...
				<div class="form-inline" style="padding: 8px;">
					<form:input class="form-control input-sm" id="name"
						placeholder="名前" size="45" path="managerName" readonly="true"/>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="form-inline" style="padding: 8px;">
					<form:input class="form-control input-sm" id="email"
						placeholder="Password" size="45" path="managerPassword" readonly="true"/>
				</div>
			</div>
		</div>
		<div class="text-center">
		...
		<div class="text-center">
			<a href="managerUpdate"><button type="button"
