...
<body>
	...
	<div class="text-center">
		<h2>こちらでよろしいですか？</h2>
		<section id="hero" class="section "></section>
		<form:form action="accountUpdateConfirm" method="post"
				...
				<div class="form-inline" style="padding: 8px;">
					...
					<c:if test="${!t}">
						<form:input type="text" class="form-control input-sm"
							id="phoneName" placeholder="新しい電話番号" size="45" path="tel"
							readonly="true" />
					</c:if>
					<c:if test="${t}">
						<form:input type="text" class="form-control input-sm"
							id="phoneName" placeholder="新しい電話番号" size="45" path="tel"
							value="${sessionScope.user.phoneNumber}" readonly="true" />
					</c:if>
				</div>
			</div>
			<div class="row">
				...
				<div class="form-inline" style="padding: 8px;">
					...
					<c:if test="${!n}">
						<form:input type="text" class="form-control input-sm"
							placeholder="新しい名前" size="45" path="name" readonly="true" />
					</c:if>
					<c:if test="${n}">
						<form:input type="text" class="form-control input-sm"
							placeholder="新しい名前" size="45" path="name"
			...
			<div class="row">
				...
				<div class="form-inline" style="padding: 8px;">
					...
					<c:if test="${!a}">
						<form:input type="text" class="form-control input-sm"
							placeholder="ご住所" size="45" path="address" readonly="true" />
					</c:if>
					<c:if test="${a}">
						<form:input type="text" class="form-control input-sm"
							placeholder="ご住所" size="45" path="address"
							value="${sessionScope.user.address}" readonly="true" />
					</c:if>
				</div>
			</div>
			<div class="row">
				...
				<div class="form-inline" style="padding: 8px;">
					<form:password class="form-control input-sm" placeholder="Password"
						size="45" path="pass" readonly="true" showPassword="true"/>

				</div>
			</div>
			<div class="text-center">
				<form:button class="btn btn-success btn-xs">次へ<span
