		...
		<div class="container">
			...
			<form:form action="userUpdateResult" modelAttribute="yamazon"
				...
				<div class="row">
					...
					<div class="form-inline" style="padding: 8px;">
						<form:input type="text" class="form-control input-sm"
							path="newName" placeholder="ユーザー名" size="45"></form:input>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="form-inline" style="padding: 8px;">
						<form:input type="text" class="form-control input-sm"
							path="newPhoneNumber" placeholder="電話番号" size="45"></form:input>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="form-inline" style="padding: 8px;">
						<form:input type="text" class="form-control input-sm"
							path="newAddress" placeholder="住所" size="45"></form:input>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="form-inline" style="padding: 8px;">
						<form:input type="text" class="form-control input-sm"
							path="newPassword" placeholder="パスワード" size="45"></form:input>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="form-inline" style="padding: 8px;">
						<form:input type="text" class="form-control input-sm"
							path="rePassword" placeholder="パスワード(再入力)" size="45"></form:input>
					</div>
				</div>
