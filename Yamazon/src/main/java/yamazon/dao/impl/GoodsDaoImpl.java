...
public class GoodsDaoImpl implements GoodsDao {
	...
	public List<Goods> findWord(String keyWord) {
		List<Goods> list = jdbcTemplate.query("SELECT goods_number, goods_name, goods_explain, goods_image, price, tax_price, category, stock FROM goods_info WHERE goods_explain LIKE ? OR goods_explain LIKE ? OR goods_explain LIKE ?",
		new BeanPropertyRowMapper<Goods>(Goods.class),
